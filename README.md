...
## 基于Springboot+Vue+ai问诊的宠物医院系统(源代码+数据库+17000字论文+开题)086
...
用户角色包含以下功能：
- 登录、注册、AI问诊、宠物列表、健康指南、预约列表、宠物日志、健康标准、宠物健康史、个人中心、密码修改

医生角色包含以下功能：
- 登录、AI问诊、宠物列表、健康指南、宠物日志、健康标准管理、预约列表管理、宠物健康史、个人中心、密码修改
